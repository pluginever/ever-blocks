...
/**
 * Generated CSS for block instances: compiles each block's style attribute into the rules core does not generate.
 *
 * @since   2.0.0
 * @package EverBlocks
 */
class Styles {
	...
	public function render( string $content, array $block ): string {
		...
		return $this->apply( $content, $name, $this->compile( $style, $block_type ) );
	}
