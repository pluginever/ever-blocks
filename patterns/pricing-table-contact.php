...
<!-- wp:ever-blocks/pricing-price {"perOption":true,"prices": {"monthly": {"amount": "<?php echo esc_html( __( 'Custom', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_html( __( 'Billed annually, invoiced', 'ever-blocks' ) ); ?>"}, "yearly": {"amount": "<?php echo esc_html( __( 'Custom', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_html( __( 'Billed annually, invoiced', 'ever-blocks' ) ); ?>"}}} /-->
