...
?>
<!-- wp:ever-blocks/pricing-table {"layout": "card", "align": "wide", "options": [{"slug": "monthly", "label": "<?php echo esc_js( __( 'Monthly', 'ever-blocks' ) ); ?>"}, {"slug": "yearly", "label": "<?php echo esc_js( __( 'Yearly', 'ever-blocks' ) ); ?>", "badge": "<?php echo esc_js( __( 'Save 20%', 'ever-blocks' ) ); ?>"}], "active": "yearly"} -->
...
<!-- wp:ever-blocks/pricing-price {"perOption":true,"prices": {"monthly": {"currency": "$", "amount": "9", "period": "<?php echo esc_js( __( '/ month', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( 'Billed monthly', 'ever-blocks' ) ); ?>"}, "yearly": {"currency": "$", "amount": "7", "period": "<?php echo esc_js( __( '/ month', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( '$84 billed yearly', 'ever-blocks' ) ); ?>"}}} /-->
...
<!-- /wp:ever-blocks/pricing-column -->
<!-- wp:ever-blocks/pricing-column {"featured": true, "badge": "<?php echo esc_js( __( 'Most popular', 'ever-blocks' ) ); ?>"} -->
...
<!-- wp:ever-blocks/pricing-price {"perOption":true,"prices": {"monthly": {"currency": "$", "amount": "29", "period": "<?php echo esc_js( __( '/ month', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( 'Billed monthly', 'ever-blocks' ) ); ?>"}, "yearly": {"currency": "$", "amount": "24", "period": "<?php echo esc_js( __( '/ month', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( '$288 billed yearly', 'ever-blocks' ) ); ?>"}}} /-->
...
<!-- wp:ever-blocks/pricing-price {"perOption":true,"prices": {"monthly": {"currency": "$", "amount": "79", "period": "<?php echo esc_js( __( '/ month', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( 'Billed monthly', 'ever-blocks' ) ); ?>"}, "yearly": {"currency": "$", "amount": "65", "period": "<?php echo esc_js( __( '/ month', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( '$780 billed yearly', 'ever-blocks' ) ); ?>"}}} /-->
<!-- wp:buttons --><div class="wp-block-buttons"><!-- wp:button {"width": 100, "className": "is-style-outline"} --><div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-outline"><a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Start free trial', 'ever-blocks' ); ?></a></div><!-- /wp:button --></div><!-- /wp:buttons -->
<!-- wp:paragraph --><p><a href="#"><?php esc_html_e( 'Compare all features', 'ever-blocks' ); ?></a></p><!-- /wp:paragraph -->
...
<!-- wp:ever-blocks/pricing-price {"perOption":true,"prices": {"monthly": {"amount": "<?php echo esc_js( __( 'Custom', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( 'Billed annually, invoiced', 'ever-blocks' ) ); ?>"}, "yearly": {"amount": "<?php echo esc_js( __( 'Custom', 'ever-blocks' ) ); ?>", "note": "<?php echo esc_js( __( 'Billed annually, invoiced', 'ever-blocks' ) ); ?>"}}} /-->
