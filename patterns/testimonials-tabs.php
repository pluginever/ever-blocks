...
<!-- /wp:tab-list -->
<!-- wp:tab-panels -->
<div class="wp-block-tab-panels"><!-- wp:tab-panel {"label":"<?php echo esc_js( __( 'Name 1', 'ever-blocks' ) ); ?>"} -->
<section role="tabpanel" tabindex="0" class="wp-block-tab-panel"><!-- wp:ever-blocks/testimonial {"quote":"<?php echo esc_js( __( 'We replaced three plugins with this one and the site got faster. Every block just works the way the editor already does.', 'ever-blocks' ) ); ?>","name":"<?php echo esc_js( __( 'Name', 'ever-blocks' ) ); ?>","role":"<?php echo esc_js( __( 'Role, Company', 'ever-blocks' ) ); ?>","rating":5,"avatarUrl":"<?php echo esc_url( EVER_BLOCKS_URL . 'assets/images/avatar.svg' ); ?>","layout":"centered","className":"is-style-plain"} /--></section>
<!-- /wp:tab-panel -->
<!-- wp:tab-panel {"label":"<?php echo esc_js( __( 'Name 2', 'ever-blocks' ) ); ?>"} -->
<section role="tabpanel" tabindex="0" class="wp-block-tab-panel"><!-- wp:ever-blocks/testimonial {"quote":"<?php echo esc_js( __( 'The controls are where I expect them. I spent an afternoon and rebuilt our pricing page without touching CSS.', 'ever-blocks' ) ); ?>","name":"<?php echo esc_js( __( 'Name', 'ever-blocks' ) ); ?>","role":"<?php echo esc_js( __( 'Role, Company', 'ever-blocks' ) ); ?>","rating":4.5,"avatarUrl":"<?php echo esc_url( EVER_BLOCKS_URL . 'assets/images/avatar.svg' ); ?>","layout":"centered","className":"is-style-plain"} /--></section>
<!-- /wp:tab-panel -->
<!-- wp:tab-panel {"label":"<?php echo esc_js( __( 'Name 3', 'ever-blocks' ) ); ?>"} -->
<section role="tabpanel" tabindex="0" class="wp-block-tab-panel"><!-- wp:ever-blocks/testimonial {"quote":"<?php echo esc_js( __( 'Support answered in an hour and the fix shipped the next day.', 'ever-blocks' ) ); ?>","name":"<?php echo esc_js( __( 'Name', 'ever-blocks' ) ); ?>","role":"<?php echo esc_js( __( 'Role, Company', 'ever-blocks' ) ); ?>","rating":5,"avatarUrl":"<?php echo esc_url( EVER_BLOCKS_URL . 'assets/images/avatar.svg' ); ?>","layout":"centered","className":"is-style-plain"} /--></section>
<!-- /wp:tab-panel --></div>
<!-- /wp:tab-panels --></div>
<!-- /wp:tabs -->
